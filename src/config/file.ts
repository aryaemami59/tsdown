 ...
 * @param configLoader - The {@linkcode InlineConfig.configLoader | config loader} to use.
 ...
 *
 * @param inlineConfig - The inline config supplied by the caller (CLI flags or programmatic options). {@linkcode InlineConfig.config | inlineConfig.config} controls file selection.
...
type Parser = Exclude<
  NonNullable<Required<InlineConfig>['configLoader']>,
  'auto'
>
