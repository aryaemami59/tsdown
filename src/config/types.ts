...
export interface UserConfig {
   ...
   * @see {@link https://rolldown.rs/options/treeshake | Rolldown documentation} for more details.
   */
...
export type UserConfigFn =
   ...
   * branch on whether the build is running inside a CI environment (detected
   * via {@linkcode https://github.com/sindresorhus/is-in-ci | is-in-ci}).
   *
   * @example
   ...
   * @returns One or more {@link UserConfig | config} objects, or a {@linkcode Promise | promise} that resolves to one or more {@link UserConfig | config} objects.
   */
  (
