...
export interface ExportsOptions {
  ...
  /**
   * Generate legacy fields ({@linkcode PackageJson.main | main} and
   * {@linkcode PackageJson.module | module}) for older Node.js and bundlers
   * that do not support package {@linkcode PackageJson.exports | exports}
   * field.
   *
