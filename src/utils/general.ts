 ...
 * {@linkcode https://github.com/micromatch/picomatch | picomatch}.
 * {@linkcode RegExp} patterns use
 * {@linkcode RegExp.prototype.test | RegExp.test()}.
 *
...
/**
 * Create a {@linkcode Promise} together with its
 * {@linkcode Promise.resolve | resolve()} function, exposed separately so that
 * external code can settle the {@linkcode Promise}.
 *
 * @template T - The type of the promise's resolved value.
 *
 * @returns An object with `promise` and the corresponding {@linkcode resolve | resolve()} callback.
 */
